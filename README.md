...
关键词：飞猫云、飞猫云怎么样、飞猫机场评测、VLESS、原生 IP、德国节点、土耳其节点、越南节点、学生版、科学上网。

---

## 一句话结论

飞猫云在本站收录 8 家里胜在**覆盖面**：**9 个地区、57 个节点**，除了常规的港台日新美，还有**德国、土耳其、菲律宾、越南**——需要小众地区的人可选项本来就不多，它是其中一个。

主力档星耀版 **¥25/月 150GB**（每 GB 约 ¥0.17），学生版年付 ¥84 折合 **¥7/月**，是收录里门槛最低的长期档之一。协议是 VLESS，官方标注 IPLC / BGP / 原生 IP 三类线路。
...
| 套餐 | 月付 | 流量 | 每 GB | 说明 |
| :-- | :-- | :-- | :-- | :-- |
| 学生版 | 折合 ¥7（**仅年付**） | 50GB/月 | ¥0.14 | 年付 ¥84 |
| **星耀版（主推）** | **¥25** | **150GB** | **¥0.17** | 月付 |
| 星环版 | ¥45 | 300GB | ¥0.15 | 月付 |
| 银河版 | ¥85 | 600GB | ¥0.14 | 月付 |
| 宇宙版 | ¥150 | 1TB | ¥0.15 | 月付 |
| 不限时套餐 | ¥680 一次性 | 1TB | ¥0.66 | 流量永久有效 |

往上加档单价基本持平（¥0.14–0.15），按实际用量选就行。**不限时档 ¥0.66/GB 是月付档的近四倍**，除非用量极不规律或买来当备用，否则不推荐。

## 小众地区：它的长处，也是最需要验证的地方

大多数机场的地区列表是港台日新美五件套。飞猫云多出四个，对特定需求有实际价值——德国 IP 访问欧洲服务、土耳其区应用商店定价、东南亚本地网络环境。

**但必须打个折扣看。** 同类机场的常见情况是：可用带宽集中在港/日/新/台，欧洲和东南亚节点往往是凑数的，标着能连、实际跑不动。本站尚未独立测速，无法替它背书。

**如果你买飞猫云就是冲着土耳其或越南节点**：先买一个月星耀版，专门测那个节点，跑通了再考虑年付。不要因为列表上有就默认能用。

## 原生 IP 有什么用

AI 平台和流媒体判定你在哪个地区，靠的是**出口 IP 的归属**。原生 IP（看起来像普通住宅网络）比机房广播 IP 更不容易被判成代理——Claude、Netflix 这类风控严的服务尤其吃这一套。

官方标注 ChatGPT、Claude、Gemini 三家可用；Claude Code、Codex 未见标注，重度依赖的话先自测。

## 买之前必须知道的

**开业年份官方未公开**，公开资料里也查不到，所以本站不填这个数字，运营历史无从核对——这意味着跑路风险不好评估。建议先月付验证，不要一次性投入 ¥680 那档。
...
本站每天 20:00 从海外探测节点探测一次飞猫云官网入口，数据公开可引用。

| 指标 | 数值 |
| :-- | :-- |
| 最近一次检测 | 2026-09-24 20:00 |
| 官网状态 | 在线（551ms） |
| 30 天可用率 | 100%（已测 7 天） |
| 连续正常 | 7 天 |
...
| :-- | :-- | :-- | :-- | :-- | :-- |
| 星耀版（主推） | ¥25/月 | 150GB | ¥0.17 | IPLC 专线 / BGP 中转 / 原生 IP | 收录 7 天 |
